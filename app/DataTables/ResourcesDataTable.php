...
class ResourcesDataTable extends DataTable
{
     ...
     *
     * @param QueryBuilder<Resource> $query
     */
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ...
            ->editColumn('created_at', function ($resource) {
                return $resource->created_at ? $resource->created_at->format('d M Y H:i') : 'N/A';
            })
            ->addColumn('action', function ($resource) {
                return view('admin.resources.resources.action', compact('resource'))->render();
            })
            ->rawColumns(['action']);
    }
