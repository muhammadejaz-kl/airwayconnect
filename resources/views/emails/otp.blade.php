                ...
                <table width="600" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td align="center" style="padding:30px 20px 10px;">
                            <img src="https://img.icons8.com/ios-filled/100/3f51b5/secured-letter.png"
                                alt="Email Verification" width="80" height="80">
                        </td>
                    </tr>

                    <tr>
                        <td align="center" style="padding:0 20px;">
                            <h2 style="color:#3f51b5; margin:20px 0 10px; font-size:24px;">Verify Your Email</h2>
                            <p style="color:#555; font-size:14px; margin:0 0 20px;">
                                Hello, <br> Use the verification code below to complete your registration.
                    ...
                    <tr>
                        <td align="center" style="padding:20px;">
                            <div
                                style="background:#f4f6fa; border:2px dashed #3f51b5; display:inline-block; padding:15px 30px; border-radius:6px; font-size:22px; font-weight:bold; letter-spacing:5px; color:#3f51b5;">
                                {{ $otp }}
                            </div>
                        </td>
                    </tr>
